# -*- coding: utf-8 -*-
"""
Created on Sat Jun  9 12:15:12 2018
Making histograms code 
code starts from line 365
@author: Ismail
"""
...
#Sumarize the given data

def describe_data_and_make_histogram(data):
    print('Mean:', np.mean(data))
    print('Standard deviation:', np.std(data))
    print('Minimum:', np.min(data))
    print('Maximum:',np.max(data))
...
print('Non_passing_students:')
non_passing_minutes = sum_grouped_items(non_passing_engagement_by_account, 'total_minutes_visited')
describe_data_and_make_histogram(list(non_passing_minutes.values()))
